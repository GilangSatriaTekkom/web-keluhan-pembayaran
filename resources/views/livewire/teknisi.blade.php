            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary d-flex row shadow-primary border-radius-lg pt-4 pb-3" style="justify-content: space-between; align-items: center;">
                        <h6 class="text-white col-2 mx-3"><strong>Data Teknisi</strong></h6>
                                ...
                                @forelse ($teknisi as $karyawan)
                                    <tr >
                                        ...
                                        <td class="align-middle text-center">
                                            <p class="text-xs text-secondary mb-0">{{ $karyawan->email }}</p>
                                        </td>
                                        <td class="align-middle text-center">
                                            <p class="text-xs text-secondary mb-0">{{ $karyawan->phone }}</p>
                                        </td>
                                        <td class="align-middle text-center">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4">
                                            <p class="text-secondary text-xs font-weight-bold mb-0">Tidak ada data karyawan.</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
