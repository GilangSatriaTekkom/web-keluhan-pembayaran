    ...
    <div class="card card-body mx-3 mx-md-4">
                            ...
                            <form wire:submit.prevent="updateUser">
                                <div class="row">
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input wire:model.defer="phone" type="text" class="form-control border border-2 p-2"
                                    ...
                                    <div class="mb-3 col-12">
                                        ...
                                        <input wire:model.defer="alamat" type="text" class="form-control border border-2 p-2" placeholder="Masukkan alamat lengkap">
        ...
        @else
            ...
            <div class="text-center py-4">
                ...
                <p class="text-muted">Pilih karyawan untuk melihat detail</p>
            </div>
        @endif
    </div>
</div>
