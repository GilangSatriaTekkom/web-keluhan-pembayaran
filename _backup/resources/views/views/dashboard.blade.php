                ...
                <div class="col-lg-12 row mt-4 col-md-6 mb-md-0 mb-4">
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="px-4 bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="col" style="color: white;">Cari Data Pelanggan</h6>
                                <div class="row gap-1 justify-content-between">
                                     <div class="px-4 col-6" style="background-color: white; border-radius: 999px;">
                                        <input type="text" wire:model.live.debounce.300ms="searchAktif"
                                            class="form-control"
                                            placeholder="Cari Customer">
                                    </div>
                                    <div class="px-4 col-4 d-flex row" style="background-color: white;">
                                        <div class="form-check d-flex align-items-center row col">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                                            <label class="col form-check-label" for="flexRadioDefault1">
                                                Keluhan
                                            </label>
                                        </div>
                                        <div class="form-check d-flex align-items-center row col">
                                            <input class="form-check-input" type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked>
                                            <label class="col form-check-label" for="flexRadioDefault2">
                                                Pembayaran
                                            </label>
                                        </div>
                                    </div>
