 <footer>
      ...
      <div
        ...
        data-background="{{asset('img/landingpage/gallery/footer_bg.png')}}"
      >
        <div class="container">
          <!-- Brand Area Start -->
            ...
            <div class="container">
              <div class="brand-active brand-border pt-50 pb-40">
                <div class="single-brand">
                  <img src="{{asset('img/landingpage/gallery/brand1.png')}}" alt="" />
                </div>
                <div class="single-brand">
                  <img src="{{asset('img/landingpage/gallery/brand2.png')}}" alt="" />
                </div>
                <div class="single-brand">
                  <img src="{{asset('img/landingpage/gallery/brand3.png')}}" alt="" />
                </div>
                <div class="single-brand">
                  <img src="{{asset('img/landingpage/gallery/brand4.png')}}" alt="" />
                </div>
                <div class="single-brand">
                  <img src="{{asset('img/landingpage/gallery/brand2.png')}}" alt="" />
                </div>
