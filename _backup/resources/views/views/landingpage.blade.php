...
@section('content')
      ...
      <div class="preloader d-flex align-items-center justify-content-center">
        <div class="preloader-inner position-relative">
          ...
          <div class="preloader-img pere-text">
            <img src="{{asset('img/landingpage/logo/Logo untuk website.png')}}" alt="" />
          </div>
        </div>
      </div>
    </div>
    <!-- Preloader Start -->
    @include('LandingPages.landingHeader')
    <!-- header end -->
    <main>
      <!-- slider Area Start-->
                ...
                <div class="col-xl-7 col-lg-6 col-md-8 col-sm-10">
                  <div class="hero__caption">
                    <h1 data-animation="fadeInUp" data-delay=".4s">
                      Dont't suffer the buffer, get super internet.
                    </h1>
                    <p data-animation="fadeInUp" data-delay=".6s">
                      Onsectetur adipiscing elit, sed do eiusmod tempor
                      incididunt ufrot bore et dolore magnt, sed do eiusmod.
                    </p>
                    <!-- Hero-btn -->
                    <div class="hero__btn">
                      <a
        ...
        <div class="container">
          <div class="row justify-content-between">
            <div class="col-xl-5 col-lg-6 col-md-9">
              <!-- about-img -->
              <div class="about-img">
                <img src="{{asset('img/landingpage/gallery/about1.png')}}" alt="" />
              </div>
            </div>
      ...
      <div class="latest-wrapper">
        <div class="container">
          <div
            class="latest-area latest-height section-bg2"
            data-background="{{asset('img/landingpage/gallery/section_bg01.png')}}"
          >
            <div class="row align-items-center justify-content-between">
              <div class="col-xl-5 col-lg-7">
                <div class="latest-caption">
                  <h2>
                    Check our unbelievable super fast Broadband availability in
                    your area.
                  </h2>
                </div>
              </div>
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-11 col-sm-11">
              ...
              <div class="about-img2">
                <img src="{{asset('img/landingpage/gallery/about2.png')}}" alt="" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="home-blog-single mb-30">
                <div class="blog-img-cap">
                  <div class="blog-img">
                    <img src="{{asset('img/landingpage/gallery/home-blog1.png')}}" alt="" />
                  </div>
                  <div class="blog-cap">
                    <h3>
                      <a href="blog_details.html"
                        >The purpose of lolght invera jgrlie.</a
                      >
                    </h3>
                    <p>January 22, 2020</p>
                  </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="home-blog-single mb-30">
                <div class="blog-img-cap">
                  <div class="blog-img">
                    <img src="{{asset('img/landingpage/gallery/home-blog2.png')}}" alt="" />
                  </div>
                  <div class="blog-cap">
                    <h3>
                      <a href="blog_details.html"
            ...
            <div class="col-lg-4 col-md-6">
              <div class="home-blog-single mb-30">
                <div class="blog-img-cap">
                  <div class="blog-img">
                    <img src="{{asset('img/landingpage/gallery/home-blog3.png')}}" alt="" />
                  </div>
                  <div class="blog-cap">
                    <h3>
                      <a href="blog_details.html"
    ...
    @include('LandingPages.landingFooter')
